...
contract ETERNITY is Context, IERC20, Ownable {
    ...
    event BuyOrSell(bool buying, uint256 taxPercent);
    ...
    function _transfer(
        ...
        //alter tax fee percent for buy or sell coming from currently set to token/eth pair 
        uint256 prevTaxfeeForBuySell = _taxFee;
        ...
        if (buyOrSell) {
            _taxFee = prevTaxfeeForBuySell;
            emit BuyOrSell(buyOrSell, _taxFee);
        }
    }
